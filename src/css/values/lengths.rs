...
enum BaselineMetricParseResult {
    Auto,
    Baseline,
    Metric(BaselineMetric),
}

fn parse_baseline_metric(value: &str) -> Option<BaselineMetricParseResult> {
...
fn remove_vertical_align_baseline_source(value: &str) -> Option<(BaselineSource, &str)> {
