...
pub(super) fn flatten_rule(
    ...
    scroll_marker_rules: &mut Vec<StyleRule>,
    scroll_marker_group_rules: &mut Vec<StyleRule>,
    ...
    match rule {
        ...
        ParsedCssRule::ScrollMarker(rule) => scroll_marker_rules.push(rule),
        ParsedCssRule::ScrollMarkerGroup(rule) => scroll_marker_group_rules.push(rule),
