...
impl<'a> LayoutBuilder<'a> {
    pub(in crate::layout) fn new(config: LayoutBuilderConfig<'a>) -> Self {
        ...
        let mut builder = Self {
            ...
            replayed_float_logical_inline_size: None,
            ...
            active_atomic_inline_coordinate_spaces: Vec::new(),
            next_atomic_inline_coordinate_space_id: 1,
            ...
            positioned_generated_source: None,
