//! Table column planning, collapsed geometry, and table-part used styles.

use crate::css::{
    self, ComputedStyle, ContentAlignmentKeyword, Display, ElementSignature, PercentageBasis,
    SemanticLengthExt, Stylesheets, TableCellVerticalAlignKeyword, TableLayout, Visibility,
...
impl<'a> LayoutBuilder<'a> {
    ...
    pub(in crate::layout::table) fn enter_table_cell_content_scope(
        ...
        self.block_percentage_context_stack
            .push_percentage_basis(definite_block_size);
        scope
    }
    ...
    pub(in crate::layout::table) fn restore_table_cell_content_scope(
        ...
        self.block_percentage_context_stack = scope.block_percentage_context_stack;
    }
    ...
    pub(in crate::layout::table) fn table_cell_content_block_offset(
        ...
        if cell_style.align_content.keyword == ContentAlignmentKeyword::Normal {
            ...
            return match cell_style.vertical_align.table_cell_align {
                TableCellVerticalAlignKeyword::Top => 0.0,
                TableCellVerticalAlignKeyword::Middle => extra / 2.0,
                TableCellVerticalAlignKeyword::Bottom => extra,
                TableCellVerticalAlignKeyword::Baseline => row_baseline_offset
