//! Table-cell content sizing and baseline-participation policy.
...
use super::{
    ...
    TableCellOuterBlockSize, TableCellPlacement, TableCellVerticalAlignKeyword, block_start_side,
...
pub(in crate::layout::table) fn table_cell_participates_in_baseline(
    ...
    matches!(
        ...
        TableCellVerticalAlignKeyword::Baseline
    )
}
