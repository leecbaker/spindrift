            ...
            if opt.preserve_text {
                ...
                match text.writing_mode {
                    ...
                    WritingMode::VerticalLr => {
                        xml.write_svg_attribute(AId::WritingMode, "vertical-lr")
                    }
                    WritingMode::SidewaysRl => {
                        xml.write_svg_attribute(AId::WritingMode, "sideways-rl")
                    }
                    WritingMode::SidewaysLr => {
                        xml.write_svg_attribute(AId::WritingMode, "sideways-lr")
                    }
                }

                match text.text_orientation {
                    TextOrientation::Mixed => {}
                    TextOrientation::Upright => {
                        xml.write_svg_attribute(AId::TextOrientation, "upright")
                    }
                    TextOrientation::Sideways => {
                        xml.write_svg_attribute(AId::TextOrientation, "sideways")
                    }
                }
